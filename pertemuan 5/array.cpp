...
int main() {
    ...
    // cout << nama.length(); //untuk mengitung jumlah karakter 
    ...
    // // 4. s1.substr(n,m) n itu mulai dari berapa, m itu panjang dari berapa
    ...
    // array <float,5> nilai = {87.5, 9, 100, 95.7, 78.3};
    // cout << "Nilai: ";
